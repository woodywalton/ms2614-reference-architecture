...
export default function Level2Diagram({ size = 'small', onNodeClick }) {
  ...
  return (
    <svg viewBox="0 0 1540 1032"
      ...
      {/* ILM → Snap6 / Snap12 — straight verticals into each box center */}
      <Arrow d={arrowPath(618, ILM_BOTTOM, 618, SNAP_Y)} kind="data" />
      <Arrow d={arrowPath(824, ILM_BOTTOM, 824, SNAP_Y)} kind="data" />
