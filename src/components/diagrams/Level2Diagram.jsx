...
export default function Level2Diagram({ size = 'small', onNodeClick }) {
  ...
  return (
    <svg viewBox="0 0 1540 912"
      ...
      {/* ── Sources ── */}
      <Node x={30} y={72}  title="Log Sources" subtitle="Full Appendix B event coverage"
      ...
      <TierFleetCard x={496} y={372} w={290} h={130}
        title="ML Nodes" subtitle={`${s.mlNodeRamGB} GB RAM · provisioned, idle at L2`}
      ...
      {/* Agent → SDP (routes through right-col lane x=460 to col bottom) */}
      <Arrow d="M 358 172 L 460 172 L 460 482 L 358 482 L 358 492" kind="data" />
      {/* Logstash → SDP (dashed because Logstash is optional at L2) */}
      ...
      {/* ILM → Snapshot 12-mo */}
      <Arrow d={zpathV(639, ILM_BOTTOM, 790, SNAP_Y, 706)} kind="data" />
      {/* Hot → Kibana SIEM (CEM) */}
