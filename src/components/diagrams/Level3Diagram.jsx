...
export default function Level3Diagram({ size = 'small', onNodeClick }) {
  ...
  return (
    <svg viewBox="0 0 1540 1064"
      ...
      <Node x={258} y={492} title="PII Masking"   subtitle="Pre-storage field redaction"
        color="coral" icon="lock"    onClick={onNodeClick} componentId="piiMasking" badges={['L3']} />
      ...
      <Node x={946} y={72}  w={250} h={100}
        ...
        color="purple" icon="machineLearningApp" onClick={onNodeClick} componentId="ml" badges={['L3']} />
      ...
      {/* PII Masking → Hot */}
      <Arrow d={zpath(458, 542, 496, 137, 472)} kind="data" />
